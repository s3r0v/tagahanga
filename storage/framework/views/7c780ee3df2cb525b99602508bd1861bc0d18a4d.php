...
} elseif ($_instance->childHasBeenRendered('slCDmaY')) {
    $componentId = $_instance->getRenderedChildComponentId('slCDmaY');
    $componentTag = $_instance->getRenderedChildComponentTagName('slCDmaY');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('slCDmaY');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('slCDmaY', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('fcWuuKK')) {
    $componentId = $_instance->getRenderedChildComponentId('fcWuuKK');
    $componentTag = $_instance->getRenderedChildComponentTagName('fcWuuKK');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fcWuuKK');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('fcWuuKK', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </li>
...
} elseif ($_instance->childHasBeenRendered('G8dzuLJ')) {
    $componentId = $_instance->getRenderedChildComponentId('G8dzuLJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('G8dzuLJ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('G8dzuLJ');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('G8dzuLJ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php endif; ?><?php /**PATH /var/www/tagahanga.ru/data/www/tagahanga.ru/resources/views/partials/topnavi.blade.php ENDPATH**/ ?>