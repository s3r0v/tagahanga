			...
			<?php if($profile->monthlyFee): ?>
				...
				<?php else: ?>
					...
					<div class="dropdown-menu" aria-labelledBy="premiumPostsLink">
						...
						<?php if(opt('unitPayEnable', 'No') == 'Yes'): ?>
							<a class="dropdown-item" href="<?php echo e(route('unitpay', [ 'user' => $profile->user->id ])); ?>">
								Unitpay
							</a>
						<?php endif; ?>

						<a class="dropdown-item" href="<?php echo e(route('payeer', [ 'user' => $profile->user->id ])); ?>">
							Payeer
						</a>
						
						<a class="dropdown-item" href="<?php echo e(route('yandex.subscribe', [ 'user' => $profile->user->id ])); ?>">
							Yandex
						</a>
					</div>
					</div>
...
} elseif ($_instance->childHasBeenRendered('c54XwBY')) {
    $componentId = $_instance->getRenderedChildComponentId('c54XwBY');
    $componentTag = $_instance->getRenderedChildComponentTagName('c54XwBY');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c54XwBY');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('c54XwBY', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tagahanga.ru/data/www/tagahanga.ru/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>