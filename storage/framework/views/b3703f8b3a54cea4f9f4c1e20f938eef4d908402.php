        ...
        <div class="dropdown show z-9999 d-inline">
            ...
            <div class="dropdown-menu" aria-labelledBy="tipPaymentMethodLink">
                ...
                <?php if(opt('unitPayEnable', 'No') == 'Yes'): ?>
                    <a class="dropdown-item submitTipBtn" href="#tipViaUnitPay" data-id="<?php echo e($post->id); ?>" data-gateway="unitPay">
                        Unitpay
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?><?php /**PATH /var/www/tagahanga.ru/data/www/tagahanga.ru/resources/views/tips/tip-form.blade.php ENDPATH**/ ?>