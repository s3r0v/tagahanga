...
<div class="row">
	<div class="col-xs-12 col-sm-6">
		<select name="payout_gateway" class="form-control">
			...
			<option value="QIWI" <?php if(isset($p) AND $p->payout_gateway == 'QIWI' ): ?> selected <?php endif; ?>>QIWI</option>
			<option value="Yandex money" <?php if(isset($p) AND $p->payout_gateway == 'Yandex money' ): ?> selected <?php endif; ?>>Yandex money</option>
		</select>
	</div>
</div>
<br>
...
<br>
	<label><strong>Номер кошелька QIWI<br/><small>Заполните, если выбрали QIWI для выплат</small></strong></label>
<div class="row">
	<div class="col-xs-12 col-sm-6">
		<input type="text" class="form-control" name="qiwi" value="<?php if(isset($p) AND $p->payout_gateway == 'QIWI'): ?> <?php echo e($p->payout_details); ?> <?php endif; ?>"/>
	</div>
</div>
<br>
	<label><strong>Номер кошелька Yandex Money<br/><small>Заполните, если выбрали Yandex money для выплат</small></strong></label>
<div class="row">
	<div class="col-xs-12 col-sm-6">
		<input type="text" class="form-control" name="yandex_money" value="<?php if(isset($p) AND $p->payout_gateway == 'Yandex money'): ?> <?php echo e($p->payout_details); ?> <?php endif; ?>"/>
	</div>
</div>
<br>
...
<?php echo $__env->make( 'account' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tagahanga.ru/data/www/tagahanga.ru/resources/views/profile/set-fee.blade.php ENDPATH**/ ?>