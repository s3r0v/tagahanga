...
} elseif ($_instance->childHasBeenRendered('mGTEOsw')) {
    $componentId = $_instance->getRenderedChildComponentId('mGTEOsw');
    $componentTag = $_instance->getRenderedChildComponentTagName('mGTEOsw');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mGTEOsw');
} else {
    $response = \Livewire\Livewire::mount('message');
    $dom = $response->dom;
    $_instance->logRenderedChild('mGTEOsw', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/tagahanga.ru/data/www/tagahanga.ru/resources/views/messages/inbox.blade.php ENDPATH**/ ?>