...
Route::get('subscribe/payeer/{user}', 'SubscriptionController@payPayeer')->name('payeer');
Route::get('subscribe/paypal/{user}', 'SubscriptionController@paypal')->name('subscribeViaPaypal');
Route::get('subscribe/unitpay/{user}', 'SubscriptionController@unitpay')->name('unitpay');
...
// Yandex
Route::get('subscribe/yandex/{user}', 'YandexController@subscribe')->name('yandex.subscribe'); // Subscribe
Route::post('yandex/status', 'YandexController@status');
...
// Payeer Webhooks
Route::get('/payeer/status', 'PayeerController@payOrderFromGate');
Route::get('/payeer/success', 'PayeerController@payOrderFromGate');
Route::get('/payeer/fail', 'PayeerController@payOrderFromGate');
