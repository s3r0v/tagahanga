...
class ProfileController extends Controller
{
    ...
    public function saveMembershipFee(Request $r)
    {
        ...
        $this->validate($r, [
            ...
            'yandex_money' => 'required_if:payout_gateway,==,Yandex money',
            'qiwi' => 'required_if:payout_gateway,==,QIWI',
        ...
        if($r->payout_gateway == 'PayPal') {
            $p->payout_details = $r->paypal_email;
        }
        if($r->payout_gateway == 'Bank Transfer') {
            $p->payout_details = $r->bank_details;
        }
         if($r->payout_gateway == 'QIWI') {
            $p->payout_details = $r->qiwi;
        }
         if($r->payout_gateway == 'Yandex money') {
            $p->payout_details = $r->yandex_money;
        }
